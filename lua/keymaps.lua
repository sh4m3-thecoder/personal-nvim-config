...
keymaps({
	...
	["<leader>Ca"] = { mode = { NORMAL }, "<cmd>CompetiTest add<cr>", { desc = "Add Testcases" } },
	["<leader>dt"] = { mode = { NORMAL }, "<cmd>DapTerminate<cr>", { desc = "Terminate Debugger" } },
	["<leader>dc"] = { mode = { NORMAL }, "<cmd>DapContinue<cr>", { desc = "Start Debugger / Continue Breakpoint" } },
